...
ask = ask_user('Would you like to: Encrypt or Decrypt your message? ')
...
if choice == 'encrypt':
    while ask1 not in ('1', '2', '3'):
        ...
        if ask1 not in ('1', '2', '3'):
            print('Please pick one of the options above by typing 1 or 2')
...
if ask1 in (str('1'), str('3')) or ask1 == 'y':
    keys = num_check('\nWhat is the key? ')
...
if ask1 in (str('1'), str('2')) or ask1 in ('y', 'yes'):
    ask_text = check_text('\nEnter your Text: ')
